...
const english: Record<string, string> = {
  ...
  'Ваши события': 'Your activity',
  'Новые моменты и изменения в вашем общем пространстве.': 'New moments and changes in your shared space.',
  'Прочитать все': 'Mark all as read',
  'Список уведомлений': 'Notification list',
  'Уведомлений пока нет': 'No notifications yet',
  'Какие уведомления получать': 'Which notifications to receive',
  'Выберите темы, о которых хотите узнавать.': 'Choose the topics you want to hear about.',
  'Приглашения и отношения': 'Invitations and relationship',
  'Совместный календарь': 'Shared calendar',
  'Новое приглашение': 'New invitation',
  'Приглашение принято': 'Invitation accepted',
  'Приглашение отклонено': 'Invitation declined',
  'Партнёр принял ваше приглашение': 'Your partner accepted your invitation',
  'Пользователь отклонил ваше приглашение': 'The user declined your invitation',
  'Новое совместное событие': 'New shared event',
  'Совместное событие изменено': 'Shared event updated',
  'Совместное событие удалено': 'Shared event deleted',
  'Новое фото на доске дня': 'New Daily Board photo',
  'Партнёр добавил фотографию дня': 'Your partner added a Daily Board photo',
  'скоро': 'soon',
  'Открыть': 'Open',
  ...
  'Ваши личные и совместные планы, встречи и важные даты.': 'Your personal and shared plans, meetings, and important dates.',
  'Фильтр событий': 'Event filter',
  'Все': 'All',
  'Мои личные': 'My personal',
  'Совместные': 'Shared',
  'Добавил партнёр': 'Added by partner',
  'Личное': 'Personal',
  'Совместное': 'Shared',
  'Личное событие': 'Personal event',
  'Совместное событие': 'Shared event',
  'Участники:': 'Participants:',
  'Совместное событие сохранено в истории и доступно только для просмотра.': 'This shared event is archived and available as read-only.',
  'Кому видно событие': 'Who can see this event',
  'Только мне': 'Only me',
  'Мне и партнёру': 'Me and my partner',
  'Совместные события станут доступны после создания пары.': 'Shared events become available after you create a couple.',
  '«{title}» будет удалено из календаря для вас обоих.': '“{title}” will be removed from the calendar for both of you.',
  '«{title}» будет удалено из вашего личного календаря.': '“{title}” will be removed from your personal calendar.',
  ...
  'Архив прошлых отношений': 'Past relationship photos',
  'К вишлистам': 'Back to wishlists',
  'Здесь сохранены желания партнёра на момент удаления аккаунта. Их можно только просматривать.': 'These are your partner’s wishes saved when their account was deleted. They are read-only.',
  'Вишлистов не было': 'There were no wishlists',
  'Желаний не было': 'There were no wishes',
  'Ссылка на желание': 'Wish link',
  'Удалить аккаунт': 'Delete account',
  'Удалить аккаунт?': 'Delete account?',
  'Аккаунт и доступ к нему будут удалены. Текущие отношения завершатся, а общие фотографии, события и желания останутся партнёру в архиве.': 'Your account and access will be deleted. Your current relationship will end, while shared photos, events, and wishes will remain in your partner’s archive.',
  'Введите текущий пароль для удаления аккаунта. Восстановить аккаунт после этого нельзя.': 'Enter your current password to delete the account. The account cannot be restored afterward.',
  'Я понимаю, что аккаунт нельзя восстановить, а отношения завершатся.': 'I understand that the account cannot be restored and the relationship will end.',
  'Подтвердите, что понимаете последствия удаления': 'Confirm that you understand the consequences of deletion',
  'Не удалось удалить аккаунт': 'Failed to delete account',
  'Загрузка...': 'Loading...',
  'Фотографии завершённых отношений доступны здесь только для просмотра.': 'Photos from past relationships are available here in read-only mode.',
  'Здесь появятся фотографии завершённых отношений.': 'Photos from past relationships will appear here.',
  'Не удалось загрузить архив': 'Failed to load archive',
  'Фото: {count}': 'Photos: {count}',
  'История с {name}': 'History with {name}',
  'С {start} по {end}': 'From {start} to {end}',
  ...
  'Пол ещё не указан. Выберите его и сохраните изменения.': 'Gender is not specified yet. Select it and save your changes.',
  ...
  'Управляйте электронной почтой, паролем и сеансами вашего аккаунта.': 'Manage your account email, password, and sessions.',
  'Другие сеансы': 'Other sessions',
  'Завершите вход на других устройствах. На этом устройстве вы останетесь в аккаунте.': 'Sign out on other devices. You will remain signed in on this device.',
  'Завершить другие сеансы': 'Sign out on other devices',
  'Другие сеансы завершены. Вы остались в аккаунте.': 'Other sessions have ended. You are still signed in.',
  'Не удалось завершить другие сеансы': 'Failed to end other sessions',
  'Сессии уже изменились. Обновите страницу и попробуйте снова': 'Sessions have changed. Refresh the page and try again.',
  ...
  'Подтвердить изменение email': 'Confirm email change',
  'Введите текущий пароль, чтобы сохранить новый email.': 'Enter your current password to save the new email.',
  'Введите текущий пароль, чтобы завершить вход на других устройствах.': 'Enter your current password to sign out on other devices.',
  ...
  'Партнёр, дата начала и завершение отношений.': 'Partner, start date, and ending the relationship.',
  'Совместные события останутся в календаре только для просмотра. Фотографии появятся в архиве прошлых отношений. Если вы снова станете парой, они вернутся на доску дня.': 'Shared events will remain in the calendar as read-only. Photos will appear in the past relationship archive. If you become a couple again, they will return to the Daily Board.',
  ...
  'Статус желания': 'Wish status',
  'В планах': 'Planned',
  'Купить позже': 'Buy later',
  'Подарено / получено': 'Gifted / received',
  'Отметка подарка': 'Gift mark',
  'Без отметки': 'No mark',
  'Планирую подарить': 'Planning to gift',
  'Уже куплено': 'Already purchased',
  'Сюрприз: владелец желания не увидит эту отметку.': 'Surprise: the wish owner will not see this mark.',
  'Подарок уже куплен': 'The gift is already purchased',
  'Подарок планируют купить': 'The gift is planned',
  'Не удалось сохранить отметку подарка': 'Failed to save the gift mark',
  'Получено': 'Received',
  'Подарено': 'Gifted',
  'Планирую': 'Planning',
  'Куплено': 'Purchased',
  'Больше не актуально': 'No longer needed',
  'Подарено — в архив': 'Gifted — archive',
  'Сюрприз: владелец желания не увидит эту отметку до вручения.': 'Surprise: the wish owner will not see this mark until the gift is given.',
  'Не удалось переместить желание в архив': 'Failed to move the wish to the archive',
  'Не удалось вернуть желание': 'Failed to restore the wish',
  'Не удалось обновить желание': 'Failed to update the wish',
  'Переместить желание «{title}» в архив как полученное?': 'Move “{title}” to the archive as received?',
  'Подарок уже вручён? Желание переместится в архив.': 'Has the gift been given? The wish will move to the archive.',
  'Здесь хранятся полученные и больше не актуальные желания. Их можно вернуть в активный список.': 'Received and no longer needed wishes are stored here. You can return them to the active list.',
  'Полученные желания': 'Received wishes',
  'Вернуть в список': 'Return to list',
  'Прошлые отношения': 'Past relationships',
  'Сохранённые желания партнёра доступны только для просмотра.': 'Saved wishes from a former partner are read-only.',
